...
const AppointmentScheduleTable = () => {
    ...
    const [columns, setColumns] = useState(["Patient Name", "Email", "Phone", "Doctor", "Date & Time", "Actions"]);
    const allColumns = ["Patient Name", "Email", "Phone", "Doctor", "Date & Time", "Actions"];
    ...
    const toggleColumn = (column) => {
        setColumns((prevColumns) =>
            prevColumns.includes(column)
                ...
                : allColumns.filter((col) => prevColumns.includes(col) || col === column)
        );
    };
            ...
            <div className="appointmentSchedule-container">
                <CCard className="ccard">
                    <CCardBody>
                        ...
                        <CDropdown className="mb-3 dropdown_filter">
                            <CDropdownToggle className="d-flex align-items-center">
                                <FaFilter className="me-2" />
                            </CDropdownToggle>
                            <CDropdownMenu className="p-2">
                                {allColumns.map((column) => (
                                    <CDropdownItem key={column} className="d-flex align-items-center">
